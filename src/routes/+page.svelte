    ...
    <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
      <div class="flex lg:flex-1">
        <a href="#" class="-m-1.5 p-1.5">
          ...
          <img class="h-8 w-auto" src="/images/UniFrame-full.svg" alt="">
        </a>
      </div>
        ...
        <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div class="hidden sm:mb-8 sm:flex sm:justify-center">
            <div class="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-400 ring-1 ring-white/10 hover:ring-white/20">
              Announcing our next round of features. <a href="#" class="font-semibold text-white"><span class="absolute inset-0" aria-hidden="true"></span>Read more <span aria-hidden="true">&rarr;</span></a>
            </div>
          </div>
          <div class="text-center">
            <h1 class="text-4xl font-bold tracking-tight text-white sm:text-8xl">Class Photo Gallery📸</h1>
            <p class="mt-6 text-lg leading-8 text-gray-300"> Who else is feeling the blast from the past? Let's embark on this visual journey together and relive those unforgettable moments, one click at a time! </p>
            <div class="mt-10 flex items-center justify-center gap-x-6">
              <a href="/form" class="rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400"> Log in </a>
            </div>
          </div>
        </div>
        ...
        <div class="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
          <figure class="relative isolate pt-6 sm:pt-12">
            ...
            <blockquote class="text-xl font-semibold leading-8 text-white sm:text-2xl sm:leading-9">
              <p>The need for such a website arises from the human desire to capture, cherish, and relive moments that shape our lives. It's about providing a virtual home for class memories, where alumni, friends, and families can come together regardless of physical distance.</p>
            </blockquote>
